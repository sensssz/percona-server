                           ...
                           uint *key_count, int select_field_count)
{
  ...
  for (field_no=0; (sql_field=it++) ; field_no++)
  {
    ...
    {
      my_error(ER_UNSUPPORTED_COMPRESSED_COLUMN_TYPE, MYF(0), sql_field->field_name);
      DBUG_RETURN(TRUE);
    }
  ...
  */
  ...
  if (alter_info->requested_algorithm != Alter_info::ALTER_TABLE_ALGORITHM_COPY)
  {
    ...
    */
    ...
    {
      altered_table->update_compressed_columns_info(ha_alter_info.alter_info->create_list);
    }
