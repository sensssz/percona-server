...
LatchDebug::LatchDebug()
{
	...
	LEVEL_MAP_INSERT(SYNC_RECV_SPACES);
	...
	LEVEL_MAP_INSERT(SYNC_LOG_MARKER_SYS);
	...
	UNIV_NOTHROW
{
	...
	LATCH_ADD(LOG_MARKER_SYS, SYNC_LOG_MARKER_SYS,
		  log_marker_sys_mutex_key);
	...
	LATCH_ADD(RECV_SPACES, SYNC_RECV_SPACES, recv_spaces_lock_key);
