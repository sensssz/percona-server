...
#        handle  -lpthread -lm -lrt -lssl -lcrypto -ldl -lcrypt -laio  and other strings inserted that might contain
...
my $ldata   = '/home/jiamin/mysql/data';
my $execdir = '/home/jiamin/mysql/bin';
my $bindir  = '/home/jiamin/mysql/bin';

# ----------------------------------------------------------------------
# If installed, search for the compiled in directory first (might be "lib64")
# ----------------------------------------------------------------------

my $pkglibdir = fix_path('/home/jiamin/mysql/lib',"libmysql/relwithdebinfo",
                         "libmysql/release","libmysql/debug","lib/mysql","lib");

my $pkgincludedir = fix_path('/home/jiamin/mysql/include', "include/mysql", "include");
...
my $flags;
$flags->{libs} =
  [@ldflags,@lib_opts,'',' -lpthread -lm -lrt -lssl -lcrypto -ldl ','',''];
$flags->{libs_r} =
  [@ldflags,@lib_r_opts,'',' -lpthread -lm -lrt -lssl -lcrypto -ldl -lcrypt -laio ',''];
$flags->{embedded_libs} =
  [@ldflags,@lib_e_opts,'','',' -lpthread -lm -lrt -lssl -lcrypto -ldl -lcrypt -laio ','',''];
