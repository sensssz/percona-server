...
{ "ER_CANT_EXECUTE_WITH_BACKUP_LOCK", 1887, "Can\'t execute the query because you have a conflicting backup lock" },
{ "ER_COMPRESSED_COLUMN_USED_AS_KEY", 1888, "Compressed column \'%-.192s\' is not allowed in the key list" },
{ "ER_UNSUPPORTED_COMPRESSED_COLUMN_TYPE", 1889, "Can not define column \'%-.192s\' in compressed format" },
{ "ER_COMPRESSION_DICTIONARY_EXISTS", 1890, "Compression dictionary \'%-.192s\' already exists" },
{ "ER_COMPRESSION_DICTIONARY_DOES_NOT_EXIST", 1891, "Compression dictionary \'%-.192s\' does not exist" },
{ "ER_COMPRESSION_DICTIONARY_NAME_TOO_LONG", 1892, "Compression dictionary name \'%-.192s\' is too long (max length = %lu)" },
{ "ER_COMPRESSION_DICTIONARY_DATA_TOO_LONG", 1893, "Data for compression dictionary \'%-.192s\' is too long (max length = %lu)" },
{ "ER_COMPRESSION_DICTIONARY_IS_REFERENCED", 1894, "Compression dictionary \'%-.192s\' is in use" },
